        ...
        <template v-if="!loading">
          ...
          <v-card>
            <v-list two-line>
              ...
              <v-list-tile>
                <v-list-tile-content>
                  <v-list-tile-sub-title class="text--primary">Owner: <a :href="`${etherscanAddress}/address/${task.owner}`" target="_blank" rel="noopener noreferrer">{{ task.owner }}</a></v-list-tile-sub-title>
              ...
              <div class="text-xs-right">
                <v-btn color="primary" v-if="userIsTaskSupervisor" :disabled="disableConfirm" @click="confirmTask">Confirm</v-btn>
        ...
        .confirmTask(
          ...
          (err, res) => {
            if (err) {
              ...
              Event.$emit('contractStatusUpdate', 1)
            }
