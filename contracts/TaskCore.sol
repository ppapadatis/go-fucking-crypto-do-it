...
contract TaskCore is TaskOwnership {
    ...
    ///
    /// @param _id The ID of the task of interest.
    ///
    /// @return object The goal, the deadline, the stake, the fulfillment status
    ///   and the expiration status of the task.
    function getTask(uint _id) public view returns (string goal, uint deadline, uint stake, bool fulfilled, bool expired) {
